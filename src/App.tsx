...
import { NutritionProfile, NutritionResult, nutritionAPI } from './services/api';
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Assistant Nutritionnel Intelligent</p>
              </div>
            </div>
          ...
          <div className="max-w-2xl mx-auto">
            <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-8">
              ...
              <p className="text-gray-600 mb-6">
                Renseignez vos informations pour obtenir un calcul personnalisé de vos
            ...
            <div className="mt-6 bg-blue-50 border border-blue-200 rounded-xl p-4">
              <p className="text-sm text-blue-800">
                <strong>Note:</strong> Assurez-vous que votre backend FastAPI est démarré
                sur <code className="bg-blue-100 px-2 py-1 rounded">http://localhost:8000</code>
              </p>
            </div>
          </div>
        )}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="text-center text-sm text-gray-600">
            ...
            <p className="mt-2 text-xs text-gray-500">
              Données issues d'OpenFoodFacts, USDA FoodData Central et BBC Good Food
            </p>
          </div>
        </div>
      </footer>
